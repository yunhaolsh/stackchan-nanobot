...
configure_local_defaults() {
  ...
  export STACKCHAN_LOCAL_CHAT_CONTEXT_TOKENS="${STACKCHAN_LOCAL_CHAT_CONTEXT_TOKENS:-16384}"
  export STACKCHAN_LOCAL_CHAT_MAX_TOKENS="${STACKCHAN_LOCAL_CHAT_MAX_TOKENS:-1024}"
...
if [[ "$INFERENCE_MODE" == "hybrid" ]]; then
  export NANOBOT_OPENAI_COMPAT_TIMEOUT_S="${NANOBOT_OPENAI_COMPAT_TIMEOUT_S:-${STACKCHAN_HYBRID_CHAT_TIMEOUT_S:-15}}"
else
